...
export class OptionCombinationHandler {
    ...
    public convertCombinationsToRows(combinations: Combination[]): Row[] {
    ...
    public convertRowsToCombinations(rows: Row[]): Combination[] {
